                ...
                <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollViewContent}>
                    <View style={styles.divMain}>
                        <Text style={styles.subtitle}>
                            Vamos definir alguns prêmios
                        </Text>
                    </View>

                    <View>
                        <Text style={styles.texto}>
                            A ideia é bem simples. Você irá estabelecer uma meta e fazer algo quando for batida.
                            Ex: Após 2 dias limpo, irei comer um chocolate.
                        </Text>
                    </View>
